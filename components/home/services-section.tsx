...
const vendorBenefits = [
  "Compare estate agent fees across Irish markets",
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-card p-8 lg:p-10">
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Selling your property in Irish? Compare estate agents based on proven sales velocity, achieved prices, and transparent fee structures. Our methodology identifies agents with track records in your specific area.
            </p>
