...
export const metadata: Metadata = {
  ...
  description: "Submit your Dublin property details and receive competitive offers from verified estate and letting agents within 48 hours.",
}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-primary-foreground/80 leading-relaxed">
                Submit your property details below and receive competitive offers from verified Dublin agents within 48 hours.
              </p>
            </div>
          </div>
        </section>
