...
export const metadata: Metadata = {
  ...
  description: "Learn about Compare Agents - a proudly Irish-owned company with 15+ years of property industry experience. We connect serious sellers with trusted estate agents nationwide.",
}

const whyChooseUs = [
  "Proudly Irish-owned, built for the local market",
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-primary-foreground/80 leading-relaxed">
                Compare Agents is a proudly Irish-owned company built on over 15 years of experience in the property industry.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="mx-auto max-w-3xl">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Having worked closely with estate agents and sellers across the Irish property market, we understand one thing clearly: quality lead generation is essential. Our goal is simple: to connect serious property sellers with trusted estate agents nationwide.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-background py-16 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                To deliver real, high-quality leads to estate agents across the Irish property market while helping sellers make smarter decisions.
              </p>
              <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
